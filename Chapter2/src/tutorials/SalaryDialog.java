...
public class SalaryDialog {
	...
	public static void main(String[] args) {
		...
		wageString = JOptionPane.showInputDialog(null, "Input employee's hourly wage", "Salary dialog 1", JOptionPane.INFORMATION_MESSAGE);
		weeklyPay = Double.parseDouble(wageString) * HOURS_IN_WEEK;
		
		dependentString = JOptionPane.showInputDialog(null, "How many depenedents?", "Salary Dialog 2", JOptionPane.QUESTION_MESSAGE);
